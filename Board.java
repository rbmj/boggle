...
public class Board {
  ...
  public Queue<String> getWords() {
      ...
      WorkThread t1 = new WorkThread(board, englishWords, foundwords, 0, 3, 0, 5, latch);
      WorkThread t2 = new WorkThread(board, englishWords, foundwords, 3, 5, 0, 5, latch);
   ...
   * <p>You can then use the Queue methods <a href="http://docs.oracle.com/javase/1.5.0/docs/api/java/util/Queue.html">found here</a>.</p>
